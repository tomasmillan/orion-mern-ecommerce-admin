...
function Categories({swal}) {
  ...
  function deleteCategory(category){
    swal.fire({
      title: 'Esta Seguro?',
      text: `Quiere eliminar ${category.name}?`,
      ...
      <form onSubmit={saveCategory}>
        <div className="flex gap-1">
          ...
          <select
            ...
            <option value="">No existe categoria padre</option>
        ...
        <div className="mb-2">
          ...
          {properties.length > 0 && properties.map((property,index) => (
            <div className="flex gap-1 mb-2" key={properties._id}>
              <input type="text"
                     value={property.name}
                     className="mb-0"
              ...
              <input type="text"
                     ...
                     placeholder="Los valores, se representan separados por una coma"/>
              <button
