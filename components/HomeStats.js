    ...
    <div>
      ...
      <div className="tiles-grid">
        <div className="tile">
          ...
          <div className="tile-desc">{ordersToday.length} ordenes del dia</div>
        </div>
        <div className="tile">
          <h3 className="tile-header">Ultima Semana</h3>
          <div className="tile-number">{ordersWeek.length}</div>
          <div className="tile-desc">{ordersWeek.length} ordenes de esta semana</div>
        </div>
        <div className="tile">
          <h3 className="tile-header">Ultimo mes</h3>
          <div className="tile-number">{ordersMonth.length}</div>
          <div className="tile-desc">{ordersMonth.length} ordenes del mes</div>
        </div>
      </div>
      <h2>Ganancias</h2>
      <div className="tiles-grid">
        ...
        <div className="tile">
          ...
          <div className="tile-desc">{ordersWeek.length} ordenes de la semana</div>
        </div>
        <div className="tile">
          <h3 className="tile-header">Ultimo mes</h3>
